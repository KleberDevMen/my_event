...
class ParceirosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parceiro" do
    assert_difference('Parceiro.count') do
      post parceiros_url, params: { parceiro: { descricao: @parceiro.descricao, imagens: @parceiro.imagens, nome: @parceiro.nome } }
    end
  ...
  test "should update parceiro" do
    patch parceiro_url(@parceiro), params: { parceiro: { descricao: @parceiro.descricao, imagens: @parceiro.imagens, nome: @parceiro.nome } }
